/**
 * Script de Diagnóstico: Problema de Actualización de Precios en Cuenta Corriente (Simplificado)
...
class PrecioCuentaCorrienteSimplificadoDiagnostic extends BaseDiagnostic {
    constructor() {
        super('Diagnóstico Simplificado - Precios en Cuenta Corriente de Mika');
    }
...
const diagnostic = new PrecioCuentaCorrienteSimplificadoDiagnostic();
