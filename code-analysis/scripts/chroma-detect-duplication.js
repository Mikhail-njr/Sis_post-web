...
const { PatternDetector } = require('../services/chroma-pattern-detector.service');

async function detectDuplication() {
    try {
        console.log('🔍 Iniciando detección de código duplicado con ChromaDB...');
        ...
        const patternDetector = new PatternDetector(chromaService, embeddingService);
